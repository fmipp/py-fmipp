The FMI++ Python Interface for Windows and Linux
================================================
...
This package provides a stand-alone version of the Python interface for the `FMI++ Library`_ for Windows and Linux.
