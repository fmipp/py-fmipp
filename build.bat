...
SET FMIPPEX_SWIG_DIR=D:\Development\fmipp\msvc\export\swig

REM Define path to directory with compiled FMI++ import library (Release mode).
SET FMIPP_DLL_DIR=D:\Development\fmipp\msvc\Release
...
SET PYTHON_EXE=D:\Python36\python.exe
...
COPY "%FMIPPEX_SWIG_DIR%\fmippex.py" "%PY_FMIPP_DIR%\export"

REM Copy Python wrapper library generated by SWIG.
COPY "%FMIPPIM_SWIG_DIR%\Release\_fmippim.pyd" "%PY_FMIPP_DIR%\lib"
COPY "%FMIPPEX_SWIG_DIR%\Release\_fmippex.pyd" "%PY_FMIPP_DIR%\lib"

REM Copy FMI++ import/export library DLL.
COPY "%FMIPP_DLL_DIR%\fmippim.dll" "%PY_FMIPP_DIR%\lib"
COPY "%FMIPP_DLL_DIR%\fmippex.dll" "%PY_FMIPP_DIR%\lib"

REM Copy additional libraries for creating FMUs.
COPY "%FMIPP_DLL_DIR%\libfmipp_fmu_frontend.lib" "%PY_FMIPP_DIR%\export\bin"
COPY "%FMIPP_DLL_DIR%\fmi2.dll" "%PY_FMIPP_DIR%\export\bin"
