...
REM ECHO ###### Python37-x64 ######
REM ECHO y | C:\Python37-x64\Scripts\pip.exe uninstall fmipp
REM C:\Python37-x64\Scripts\pip.exe install %PY_FMIPP_DIR%\dist\fmipp-%PY_FMIPP_VERSION%-cp37-none-win_amd64.whl
REM C:\Python37-x64\Scripts\pytest.exe %PY_FMIPP_DIR%\test\test_pyfmipp.py
...
REM ECHO ###### Python38-x64 ######
REM ECHO y | C:\Python38-x64\Scripts\pip.exe uninstall fmipp
REM C:\Python38-x64\Scripts\pip.exe install %PY_FMIPP_DIR%\dist\fmipp-%PY_FMIPP_VERSION%-cp38-none-win32.whl
REM C:\Python38-x64\Scripts\pytest.exe %PY_FMIPP_DIR%\test\test_pyfmipp.py
